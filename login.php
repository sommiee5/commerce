...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col px-0">
                ...
                <!--navbar-->
                <nav class="navbar navbar-expand-lg bg-dark fixed-top nav">
                    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-6 login-form-container">
               ...
               ?>
                    ...
                    <div class="mt-4">
                        <button type="login" id="loginbtn" class="btn btn-dark col-12" name="btnsubmit" disabled>Login</button>
                    </div>
                    <hr class="mt-5 text-secondary">  
                    <div>
                        <p class="text-center text-dark">Don't have an account? <a href="signup.php" class="text-dark">Sign Up</a></p>
                    </div>
                </form>
               </div>
            </div> 
        ...
        <div class="col-md-4">
          ...
          <form action="" method="post">
            ...
            <div class="mt-3 mb-0">
              <button type="submit" name="btnsubmit" class="btn btn-primary">Subscribe</button>
            </div> 
          </form>
        </div>
   ...
   >
     <div class="offcanvas-header">
       <h2 class="offcanvas-title" id="offcanvasExampleLabel">Your Cart</h2>
       <button
         type="button"
         class="btn-close"
