...
$products = $pro->fetch_products_by_cat_id(2);
        ...
        <div class="row">
                        ...
                        <div class="col px-0" id="nav-links">
                            <div>
                                <ul class="d-flex justify-content-center list-unstyled pt-3 links text-decoration-none">
                                    <li><a href="index.php" class="nav-link">Men</li></a>
            ...
            <div class="row mx-0">
              <div class="col-md-12 px-2">
                <h2 class="men">Show All</h2>
              </div>  
          </div>
          <div class="row px-0 ms-0">
              <?php
                foreach($products as $product){
                  if ($product["products_id"] >= 9 && $product["products_id"] <= 17) { 
                  ?>
                   <div class="col-md-3 px-0 menlink">
                  <div class="men-wear px-0">
