<?php
  ...
  $male_products = $pro->fetch_products_by_cat_id(2);
  $female_products = $pro->fetch_products_by_cat_id(1);
  $access = $pro->fetch_products_by_cat_id(3);
  // $products = $pro->fetch_remaining_products();
     ...
     <nav class="navbar navbar-expand-lg bg-dark fixed-top">
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="col px-0" id="nav-links">
                            <div>
                                <ul class="d-flex justify-content-center list-unstyled pt-3 links text-decoration-none">
          ...
          <div class="row px-0">
              <?php
                foreach($male_products as $product){
                  ?>
                   <div class="col-md-3 px-0 menlink me-0 pt-3">
                  <div class="men-wear mx-0 pe-0">
                  <a href="product_detail.php?id=<?php echo $product["products_id"]?>">
                  <img src="uploads/<?php echo $product["products_image"]?>" class="img-fluid pt-3" alt="a man"></a>
          ...
          <div class="row px-0">
              <?php
                foreach($female_products as $product){
                  if ($product["products_id"] >= 18 && $product["products_id"] <= 26) { 
              ?>
                   <div class="col-md-3 px-0 prolink pt-3">
                  <div class="womens-cart px-0">
                    <a href="product_detail.php?id=<?php echo $product["products_id"]?>">
                  <img src="uploads/<?php echo $product["products_image"]?>" class="img-fluid pt-3" alt="a woman"></a>
                  <button class="add-to-cart-btn cartbtn fw-bold text-center" value="<?php echo $product["products_id"]?>">Add to cart</button>
                  <a href="product_detail.php?id=<?php echo $product["products_id"]?>">
                  <span class="ms-3 text-dark"><?php echo $product["products_name"]?>
                  </span></a> 
        ...
        <?php
             foreach($access as $product){
                  ...
                  ?>
                   <div class="col-md-3 px-0 access pt-3">
