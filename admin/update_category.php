...
<div class="col-md-9 p-3">
    ...
    <div class="row">
        ...
        <h2 class="text-center pb-2">Update Category</h2>
        <form action="process/add_new_cat_process.php" method="post">
        <?php
          ...
          <div class="form-group pb-3">
            <label class="mb-1">Add new Category</label>
            <input type="text" name="category_name" id="category-name" placeholder="Category name" class="form-control p-3">
          </div>
        <div class="pt-3">
          <button type="submit" name="btnadd" class="btn btn-dark col-12">Update Category</button>
        </div>
       </form>
      </div>
    </div>
