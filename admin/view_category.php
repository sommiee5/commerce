...
<head>
    ...
    <link rel="stylesheet" href="assets/css_all/main.css">
                 ...
                 <div class="container-fluid">
                   ...
                   <div class="collapse navbar-collapse" id="navbarNavDropdown">
                     ...
                     <a class="btn" href="#" role="button" data-bs-toggle="" aria-expanded="false">
                       <img src="" width="30" style="border-radius: 50%" class="text-danger">Hi admin</a>
              ...
              foreach($categories as $category){
                ?>
                 <tr>
                    ...
                    <div class="">
                    <td><a href="edit_cat.php?cat_id=<?php echo $category['cat_id']; ?>" class="btn btn-primary">Edit</a>
                    <form action="process/delete_cat.php" method="post" style="display:inline; margin-left: 20px;">
